...
import { type Repo, createRepo } from "./domain/repo.js";
import {
  deleteRepo,
...
export async function handleCreateRepo(owner: string, directory: string) {
  const repo = createRepo(owner, directory);
